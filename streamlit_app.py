...
METHODOLOGY = {
    "Pillars": "Amplify (Alignment), Normalize (Naming Shifts), Resist (Friction/Human Rights).",
...
if not df_all.empty:
    ...
    if not df_viz.empty:
        ...
        st.download_button("📥 Download Filtered Results as CSV", csv, "nepal_media_analysis.csv", "text/csv")
